# main.py — start robusto para web (Render) sem alterar seu layout
...
# ===== ALERTAS com fallback seguro (não derruba o app) =====
try:
...
def main(page: ft.Page):
    ...
    # Logo do topo (usa o que existir)
    ...
    # Renderização
    current_key = NAV[0][0]  # começa pela primeira do NAV
